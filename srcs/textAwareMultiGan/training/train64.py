...
def train_64(discriminator, generators, optimizerD, optimizerG, dataloaders, device, num_epochs=10, batch_size=32):

    D_64: PatchGANDiscriminator = discriminator
    G_32: Generator32 = generators[0]
    G_64: Generator64 = generators[1]
